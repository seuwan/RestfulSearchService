...
<%@page import="youTubeShow.YouTubeItem"%>
...
<html>
    ...
    <%
        List<YouTubeItem> selectYouTube = (List<YouTubeItem>) request.getAttribute("selectYouTube");
    %>
        ...
        <div class="blog-content">
            <div class="wrap">
                ...
                <div class="blog-grids">
                    <!-- blog-left-->
                    <div class="blog-left">
<c:forEach var="result" items="${selectYouTube}">
                            <h2><a href="#"><c:out value="${result.getTitle()}"/></a></h2> 
                             <br> </br>
                            ...
                            <iframe id="player" type="text/html" width='640' height='390'
                                    src='http://www.youtube.com/embed/${result.getVideoId()}' frameborder='0'></iframe> 
                            <br> </br>
                            <h6> </h6>
                            ...
                            <div class="blog-right">
                                <div class="side-bar">
                                    ...
                                    <div class="gallery">
                                        <ul>
                                            <ul>
                                                <c:forEach var="gallery" items="${selectYouTube}">
                                                    <li>
                                                        <p><img src="${gallery.getURL()}" width='50' height='50'/></p>
